...
class WNetAE(BaseAE):
    ...
    def configure_optimizers(self):
        opt = optim.AdamW(self.net.parameters(), lr=5e-6)
...
def main():
    ...
    model = WNetAE(32, f=16, num_blocks=2, mults=[1, 2, 2, 4, 4], u_net_stages=1)
    dset = ImageFolder("/data1/DALLE-datasets/general/cc12", "ixs.txt", 256, "images")
    loader = DataLoader(
        dset,
        batch_size=32,
        shuffle=False,
    ...
    logger_callback = ReconstructedImageLogger()
